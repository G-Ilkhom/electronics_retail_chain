...
Cервис по управлению данными розничной сети магазинов электроники.
Система позволяет хранить и обрабатывать информацию о сети магазинов, пользователях и связанных бизнес-операциях через REST API, а также обеспечивает доступ к документированной API-спецификации.
